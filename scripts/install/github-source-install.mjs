...
import { verifyShellParserAssets } from "../build/copy-shell-parser-assets.mjs";
import { verifyLuaParserAssets } from "../build/copy-lua-parser-assets.mjs";
...
function isForbiddenPackagePath(path) {
  ...
  return [".git", ".SymbolLattice", "benchmarks", "node_modules", "scripts", "src", "test"].includes(segments[0]);
}

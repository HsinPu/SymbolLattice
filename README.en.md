...
> [!IMPORTANT]
> v0.222.0 is a developer preview. Run it from source.
...
- The graph does not infer runtime bean/provider selection, qualifier outcomes, Java static methods, collection, generic, or vararg parameters, alias/wildcard imports, secondary constructors, or compiler classpaths.

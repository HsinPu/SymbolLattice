...
describe("first-party framework capabilities", () => {
  it("declares one executable capability for every registered extractor", () => {
    ...
    expect(frameworkCapability("spring-boot-properties")).toMatchObject({
      ...
      routeRegistrations: [],
      surfaces: [
        "direct imported or fully-qualified @Value literal-key annotations on direct Java fields, constructor parameters, or concrete-method parameters, or Kotlin class properties, primary-constructor parameters, or concrete-method parameters",

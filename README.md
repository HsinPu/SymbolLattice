...
v0.518.0 補齊 Go 無綁定 `for range` 的語法解析，並避免把 range 右側 receiver 誤判為重新賦值。四個固定大型專案共1,457檔，解析乾淨檔案從1,223增至1,256；其餘201檔仍有不支援語法。原1,223檔的AST與extraction facts一致；固定986筆關係真值維持529 TP，150筆負向契約通過。解析覆蓋率提升不等於所有新增關係已獲compiler驗證，也不代表完整Go支援或完整FP=0。

...
**Evidence-first local code intelligence for TypeScript, JavaScript, Python, Go, Rust, Java, PHP, C, Lua, R, Elixir, Erlang, Clojure, Perl, Julia, Haskell, OCaml, C++, C#, Ruby, Kotlin, Swift, Dart, and Scala projects.**
...
> [!IMPORTANT]
> **v0.57.0** is an early developer release. This public repository runs from source; its npm package is intentionally private and is not published to npm.
...
| Area | v0.57.0 behavior |
| --- | --- |
| Source files | TypeScript, TSX, JavaScript, JSX, Python, Go, Rust, Java, PHP, C, Lua, R, Elixir, Erlang, Clojure, Perl, Julia, Haskell, OCaml, C++, C#, Ruby, Kotlin, Swift, Dart, and Scala (`.c`, `.lua`, `.r`, `.ex`, `.exs`, `.erl`, `.clj`, `.pl`, `.pm`, `.jl`, `.hs`, `.ml`, `.cpp`, `.cc`, `.cxx`, `.hpp`, `.hh`, `.hxx`, `.cs`, `.rb`, `.kt`, `.swift`, `.dart`, `.scala`; plus Play `conf/routes` and `conf/*.routes` route tables) |
...
| Capability | Proven surfaces in v0.57 |
| --- | --- |
...
- Language adapters beyond TS/TSX/JS/JSX/Python/Go/Rust/Java/PHP/C/Lua/R/Elixir/Erlang/Clojure/Perl/Julia/Haskell/OCaml/C++/C#/Ruby/Kotlin/Swift/Dart/Scala, external dependency indexing, telemetry, or multi-project routing.

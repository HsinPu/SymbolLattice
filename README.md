...
**Evidence-first local code intelligence for TypeScript, JavaScript, Python, Go, Rust, Java, PHP, C, Lua, R, Elixir, Erlang, Clojure, Perl, Julia, C++, C#, Ruby, Kotlin, Swift, Dart, and Scala projects.**
...
> [!IMPORTANT]
> **v0.55.0** is an early developer release. This public repository runs from source; its npm package is intentionally private and is not published to npm.
...
| Area | v0.55.0 behavior |
| --- | --- |
| Source files | TypeScript, TSX, JavaScript, JSX, Python, Go, Rust, Java, PHP, C, Lua, R, Elixir, Erlang, Clojure, Perl, Julia, C++, C#, Ruby, Kotlin, Swift, Dart, and Scala (`.c`, `.lua`, `.r`, `.ex`, `.exs`, `.erl`, `.clj`, `.pl`, `.pm`, `.jl`, `.cpp`, `.cc`, `.cxx`, `.hpp`, `.hh`, `.hxx`, `.cs`, `.rb`, `.kt`, `.swift`, `.dart`, `.scala`; plus Play `conf/routes` and `conf/*.routes` route tables) |
...
| Capability | Proven surfaces in v0.55 |
| --- | --- |
...
flowchart LR
  ...
  Extractor["TypeScript AST extractor + Python/Go/Rust/Java/PHP/C/C++ Lezer parsers + Lua/R/Elixir/Erlang/Clojure/Perl/Julia lexical extractors + C#/Ruby/Kotlin/Swift/Dart/Scala ast-grep parsers\nfirst-party framework capability passes\nExpress/Fastify/Nest HTTP routes + Fastify plugin facts + FastAPI/Flask/Gin/net-http/Chi/Axum/Spring Web/Laravel/CivetWeb/Lapis/Plumber/Phoenix/Cowboy/Compojure/Dancer2/Genie/cpp-httplib/ASP.NET Core/Rails/Ktor/Vapor/Flutter/Play facts\nFlutter/React Router/Next client navigation\nNest module-prefix facts + non-HTTP entrypoints"] --> Facts["Reusable artifact facts"]
...
src/
  ...
  extraction/      TypeScript AST plus Python, Go, Rust, Java, PHP, C, C++ Lezer, Lua/R/Elixir/Erlang/Clojure/Perl/Julia lexical, and C#/Ruby/Kotlin/Swift/Dart/Scala ast-grep fact extraction
...
- Language adapters beyond TS/TSX/JS/JSX/Python/Go/Rust/Java/PHP/C/Lua/R/Elixir/Erlang/Clojure/Perl/Julia/C++/C#/Ruby/Kotlin/Swift/Dart/Scala, external dependency indexing, telemetry, or multi-project routing.

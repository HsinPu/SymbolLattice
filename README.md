...
> [!IMPORTANT]
> **v0.85.0** is an early developer release. This public repository runs from source; its npm package is intentionally private and is not published to npm.

> [!NOTE]
> **v0.85.0 — source-proven Zig declarations.** SymbolLattice now indexes direct top-level named Zig containers and functions only when the file is lexically balanced and the declaration form is explicit.
...
| Capability | Proven surfaces in v0.85 |
| --- | --- |

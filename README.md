...
> [!IMPORTANT]
> **v0.47.0** is an early developer release. This public repository runs from source; its npm package is intentionally private and is not published to npm.
...
| Capability | Proven surfaces in v0.47 |
| --- | --- |

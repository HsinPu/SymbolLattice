...
v0.514.0 將 58 種語言的基本掃描檢查升級為非空語料 Gate：55 種驗證宣告或資源、其中 7 種另驗證 exact call，另外 3 種驗證模板原始引用。同步修正 Go／PHP 證據版本與 COBOL 深度分類。本版改善驗證基礎，不新增解析語意，也不將小型 fixture 通過率當成大型專案召回率。

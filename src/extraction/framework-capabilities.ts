...
export const FRAMEWORK_CAPABILITIES = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "same-file and root-go.mod cross-package standard-router g.Meta request metadata with directly bound controller methods or statically proven no-argument controller factories, plus unbound unique request-signature candidates marked heuristic"
    ]
  },
  {
    id: "axum",

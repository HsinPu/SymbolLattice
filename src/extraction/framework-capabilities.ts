...
export const FRAMEWORK_CAPABILITIES = [
  ...
  },
  {
    ...
    surfaces: [
      ...
      "same-file and root-go.mod cross-package standard-router g.Meta request metadata with one or more independently statically proven direct controller, direct controller pointer alias, or no-argument factory Bind arguments, including one non-rebound local factory alias, plus unbound unique request-signature candidates marked heuristic"
    ]
  },
  {
    id: "axum",

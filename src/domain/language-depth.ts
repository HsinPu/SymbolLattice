...
const LANGUAGE_LIMITATIONS: Readonly<Partial<Record<ArtifactLanguage, readonly string[]>>> =
  Object.freeze({
    typescript: ["parse-rejected, overload, conditional export, and runtime dispatch remain nonclaims", "Named function-expression source and lexical self references are retained; assignment to a property or module.exports alone does not prove an exported call target"],
    javascript: ["300-positive/150-negative ESTree truth covers bounded same-file relations and unique relative ESM or strict CommonJS imports; dynamic imports, package resolution, re-exports, mutable globals, and runtime dispatch remain nonclaims", "Named function-expression source and lexical self references are retained; assignment to a property or module.exports alone does not prove an exported call target", "CommonJS object-call resolution requires strict JavaScript or .cjs, const named destructuring from a relative .js/.cjs file, and unique unmutated top-level function exports. Dynamic exports, namespace calls, default exports, directory/package lookup, ESM interop and cyclic imports remain unsupported; observed module-object mutation or escape suppresses affected targets"],
